...
class Ui(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.in_new_igel_description = self.findChild(QtWidgets.QTextEdit, "in_new_igel_description")
        ...
        self.in_update_igel_description = self.findChild(QtWidgets.QTextEdit, "in_update_igel_description")
    ...
    def query_selected_igel_take_medics(self):
        ...
        try:
            ...
            table.setHorizontalHeaderLabels(["Medikamente", "Datum", "ID"])
